...
const workspaceModules = [
    {
        ...
        description:
            "Theo dõi, lọc và cập nhật tasks quan trọng.",
        component: TodoApp,
    },
    {
        id: "github",
        label: "GitHub Search",
        description:
            "Truy vấn profile và repository mới nhất.",
                ...
                >
                    ...
                    <div className="module-nav__items">
                        {workspaceModules.map((module) => (
                            ...
                            >
                                <span className="module-nav__item-label">
                                    {module.label}
                                </span>
                                <span className="module-nav__item-desc">
                                    {module.description}
                                </span>
                            </button>
                        ))}
